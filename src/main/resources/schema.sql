...
CREATE TABLE IF NOT EXISTS "LIKE" (
 ...
 CONSTRAINT LIKE_FK FOREIGN KEY (USER_ID) REFERENCES "USER"(USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
 CONSTRAINT LIKE_FK_1 FOREIGN KEY (FILM_ID) REFERENCES FILM(FILM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
CREATE INDEX IF NOT EXISTS LIKE_FK_1_INDEX_4 ON "LIKE" (FILM_ID);
CREATE INDEX IF NOT EXISTS LIKE_FK_INDEX_4 ON "LIKE" (USER_ID);
CREATE UNIQUE INDEX IF NOT EXISTS PRIMARY_KEY_451 ON "LIKE" (LIKE_ID);