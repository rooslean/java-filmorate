...
CREATE TABLE IF NOT EXISTS PUBLIC.FRIEND (
 ...
 CONSTRAINT FRIEND_FK FOREIGN KEY (FOLLOWING_USER_ID) REFERENCES PUBLIC."USER"(USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
 CONSTRAINT FRIEND_FK_1 FOREIGN KEY (FOLLOWED_USER_ID) REFERENCES PUBLIC."USER"(USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE INDEX IF NOT EXISTS FRIEND_FK_1_INDEX_4 ON PUBLIC.FRIEND (FOLLOWED_USER_ID);
CREATE INDEX IF NOT EXISTS FRIEND_FK_INDEX_4 ON PUBLIC.FRIEND (FOLLOWING_USER_ID);
CREATE UNIQUE INDEX IF NOT EXISTS PRIMARY_KEY_45 ON PUBLIC.FRIEND (FRIEND_ID);
